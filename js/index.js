(function () {
    ...
    Slider.prototype.createDom = function() {
		...
		for(var i=0;i<this.imgList.length;i++){  //设置a标签属性
          if(window.location.href.indexOf("register")!=-1 || window.location.href.indexOf("login")!=-1 || window.location.href.indexOf("zbcg")!=-1 || window.location.href.indexOf("project")!=-1){
