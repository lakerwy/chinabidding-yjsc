...
function zbxx_type_huixian(table_type, selectname) {
    ...
    var opt0, opt1, opt2, opt3, opt4, opt5, opt7, opt8;
    ...
    if (temp == "2010")
        opt7 = $("<option>").attr("value", "2010").attr("selected", true).html("政府采购");
    else
        opt7 = $("<option>").attr("value", "2010").html("政府采购");
    if (temp == "2020")
        opt8 = $("<option>").attr("value", "2020").attr("selected", true).html("企业采购");
    else
        opt8 = $("<option>").attr("value", "2020").html("企业采购");

    $("select[name='" + selectname + "']").append(opt0).append(opt1).append(opt2).append(opt3).append(opt4).append(opt5).append(opt7).append(opt8);
...
function xmxx_type_huixian2(table_type, selectname) {
    ...
    if (temp == "3030")
        ...
        opt1 = $("<option>").attr("value", "3030").html("VIP项目");
    if (temp == "3020")
        opt7 = $("<option>").attr("value", "3020").attr("selected", true).html("项目核准批复");
    else
        opt7 = $("<option>").attr("value", "3020").html("项目核准批复");
    if (temp == "3110")
        opt5 = $("<option>").attr("value", "3110").attr("selected", true).html("项目公示");
    else
        opt5 = $("<option>").attr("value", "3110").html("项目公示");
    if (temp == "3120")
        opt6 = $("<option>").attr("value", "3120").attr("selected", true).html("项目预告");
    else
        opt6 = $("<option>").attr("value", "3120").html("项目预告");
    if (temp == "3050")
        opt3 = $("<option>").attr("value", "3050").attr("selected", true).html("项目动态");
    else
        opt3 = $("<option>").attr("value", "3050").html("项目动态");
...
//    else
//        opt2 = $("<option>").attr("value", "3080").html("重点招商项目");
    $("select[name='" + selectname + "']").append(opt0).append(opt1).append(opt7).append(opt5).append(opt6).append(opt3);
}
...
function shijianduan_huixian(b_date, selectname) {
    ...
    if (temp == "day")
     ...
     if (temp == "two")
        opt2 = $("<option>").attr("value", "two").attr("selected", true).html("近二周");
    else
        opt2 = $("<option>").attr("value", "two").html("近二周");
    if (temp == "month")
        opt3 = $("<option>").attr("value", "month").attr("selected", true).html("近一月");
    else
        opt3 = $("<option>").attr("value", "month").html("近一月");
    if (temp == "quarter")
        opt4 = $("<option>").attr("value", "quarter").attr("selected", true).html("近三月");
    else
        opt4 = $("<option>").attr("value", "quarter").html("近三月");
